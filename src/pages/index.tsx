...
type HomeProps = {
  latestEpisodes: Array<Episode>;     //This could be <string>, <integer>, etc. In this case it's the object "Episode"
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const episodes = data.map( episode => {        //Formatting received data right after the server response
    return {
      id: episode.id,
      title: episode.title,
